    ...
    <div className={styles.Box}>
      <div className={styles["left-part"]}>
        <div className={styles["centre-part"]}>
          ...
          <br />
          <p>
            A passionate Full Stack developer, expertise in the MERN
            (MongoDB, Express.js, React.js, Node.js) stack. With a blend of
            frontend and backend skills, I thrive on creating dynamic and
            responsive web solutions. Here's a bit more about my journey and
